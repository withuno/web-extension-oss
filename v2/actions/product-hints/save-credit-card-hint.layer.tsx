...
UnoOrchestrator.registerLayerRoute(() => ({
  ...
  element: <SaveCreditCardHint />,
  layout: <Tooltip.Layout />,
}));

function SaveCreditCardHint() {
  ...
  return (
    <Hotkey pattern="esc" onActivate={close}>
      ...
      <div className="mt-2 w-[200px]">Securely save your credit card details so Uno can autofill them next time.</div>
    </Hotkey>
  );
}
